...
public class AsignarMontoClienteController {
    @FXML
    private Button btnX;
    ...
    private void pressBtnX() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("ConfirmarCuentaCliente.fxml"));
    ...
    private void pressBtnEnviar() {
        try {
            // Cargar el archivo FXML de la vista de llaves
            FXMLLoader loader = new FXMLLoader(getClass().getResource("ConfirmarEnvioCliente.fxml"));
